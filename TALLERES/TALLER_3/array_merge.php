...
$misComidas = ["pizza", "hamburgesa", "pure de papas"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["espaqueti", "arroz con poroto", "puerco frito"]; // Reemplaza con las comidas favoritas de tu amigo
