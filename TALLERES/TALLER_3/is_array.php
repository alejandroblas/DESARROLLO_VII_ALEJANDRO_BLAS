...
$miArray = ["tu","eres","bueno"]; // Reemplaza esto con tu propio array
$miString = "ale"; // Reemplaza esto con tu propio string
$miNumero = 56; // Reemplaza esto con tu propio número
