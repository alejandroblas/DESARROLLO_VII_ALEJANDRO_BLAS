...
function mostrarInventario($inv) {
    foreach ($inv as $producto => $info) {
        echo "</br>$producto: {$info['cantidad']} unidades, Precio: {$info['precio']}\n";
    }
}
...
// Mostrar el producto con el mayor valor total en inventario
$productoConMayorValor = productoMayorValor($inventario);
echo "\nProducto con el mayor valor en inventario: $productoConMayorValor:$valorActual\n";
?>