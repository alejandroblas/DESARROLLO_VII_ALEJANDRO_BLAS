...
echo "</br>Estudiante con el promedio más alto: </br>{$mejorEstudiante['nombre']} ({$mejorEstudiante['promedio']})\n";
...
// TAREA: Identificar a los estudiantes que necesitan tutoría
...
if (!empty($estudiantesTutoria)) {
    ...
    echo "No hay estudiantes que necesiten tutoría.\n";
}
